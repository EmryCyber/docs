...
<Steps>
  <Step title="Navigate to SLA Policies">
    In the PSA module sidebar, open the **Configuration** group and click **SLA Policies**, then click **Create Policy**.
  </Step>
...
View SLA performance across clients and time periods in **PSA → Reporting → PSA Reports**. The Service Desk Overview report includes:
