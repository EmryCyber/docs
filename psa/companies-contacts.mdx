...
<Steps>
  <Step title="Open the Companies page">
    In the PSA module sidebar, open the **CRM** group and click **Companies**.
  </Step>
...
<Steps>
  <Step title="Open the company detail page">
    In the PSA sidebar, open **CRM → Companies** and select the company you want to archive.
  </Step>
...
<Steps>
  <Step title="Open the Contacts page">
    In the PSA module sidebar, open the **CRM** group and click **Contacts**.
  </Step>
