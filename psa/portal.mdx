...
Customize the portal appearance under **PSA → Configuration → Support Portal** (also reachable from the **Support Portal** tile on the main Settings page):
...
<Steps>
  <Step title="Add the domain">
    Open **PSA → Configuration → Support Portal → Custom Domain** and enter the desired subdomain.
  </Step>
