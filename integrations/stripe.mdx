...
After the initial connect, you can re-trigger the sync any time from **PSA → Finance → Catalog → Sync from Stripe** to pick up products you've added on the Stripe side.
