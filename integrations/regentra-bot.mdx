...
5. **If no organization matches**, the bot replies *"Sorry, I couldn't identify your organization. Please contact your IT administrator to set up the Regentra integration."* No ticket is created.
...
<Steps>
  <Step title="Welcome card">
    On first open (or any message when there's no active conversation), the
    bot greets the user with a card — *"Hi \{name\}! 👋 I'm the Regentra
    support bot."* — under **What would you like to do?**, with three
    buttons: **🎫 Create New Ticket**, **📋 View My Tickets**, and **❓ Help**.
  </Step>
  <Step title="Ticket creation">
    Tapping **Create New Ticket** walks the user through a 3-step card flow:
    - **Step 1 of 3 — Title** — a short summary of the issue
    - **Step 2 of 3 — Description** — details
    - **Step 3 of 3 — Priority** — one tap on 🔴 Critical, 🟠 High, 🟡 Medium,
      or 🟢 Low (stored as 4/3/2/1 respectively)
  ...
  <Step title="Ongoing conversation">
    Subsequent messages in the thread are added to the ticket as replies. Pasted images and screenshots are uploaded as ticket attachments. Technician replies in the PSA appear in the user's Teams chat in real time. Type **end**, **cancel**, **quit**, **exit**, or **stop** to close the conversation.
  </Step>
</Steps>
