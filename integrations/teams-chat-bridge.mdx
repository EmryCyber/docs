...
<Steps>
  ...
  <Step title="Verify the connection">
    Once consent is granted, you're bounced back to the Integrations page and the card shows **Connected** with the support account's email. Regentra checks for new messages every 5 minutes.
  </Step>
</Steps>
