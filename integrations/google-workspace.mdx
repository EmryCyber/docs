...
<AccordionGroup>
  ...
  <Accordion title="Test fails with 'Admin email is required' or invalid_grant">
    The Admin Email field is empty, or the address isn't a real Workspace super-admin in the same domain. Service-account delegation needs an admin to impersonate; pick one (any super-admin works) and re-save.
  </Accordion>
