...
<Tip>
  These CSV imports are separate from the dataset-registry exports above (Networks, Companies, and the others don't have a matching bulk-import path today) — they cover the record types listed in the table, not every exportable dataset.
</Tip>
