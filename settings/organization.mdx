...
Configure how long user sessions remain active before requiring re-authentication. Go to **Settings → Organization → Security** and set the session timeout. Options range from 1 hour to 30 days.
