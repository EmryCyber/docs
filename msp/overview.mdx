...
<Steps>
  <Step title="MSP organization">
    Your top-level organization. This is where your team, billing, integrations, and global settings live — and it can also run its own compliance program as a tenant in its own right, distinctly labeled from your clients. See [Your own organization as a tenant](/msp/clients#your-own-organization-as-a-tenant).
  </Step>
...
| Metric | Description |
| --- | --- |
| **Total Clients** | Total number of client organizations you manage (PSA companies plus compliance-only tenants) |
| **Active Subs** | Number of clients with an active compliance subscription |
| **Avg Compliance** | Average compliance score across your clients that have one |
| **Open Tickets** | Aggregate open ticket count across all clients |
