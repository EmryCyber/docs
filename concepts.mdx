...
A **framework** is a compliance standard you can adopt within your organization. Regentra supports eleven frameworks: HIPAA 2026, NIST CSF 2.0, SOC 2, ISO 27001, CMMC Level 1, CMMC Level 2, PCI DSS, GDPR, FTC Safeguards, SEC Regulation S-P, and FINRA. CMMC Level 1 and Level 2 are adopted independently.
...
<AccordionGroup>
  ...
  <Accordion title="COMPLIANCE_OFFICER">
    Works within the compliance module. Can update control statuses, upload evidence, manage policies, and run assessments. Displayed in the Team UI as **Approver**.
  </Accordion>
  <Accordion title="PRIVACY_OFFICER">
    Approver role focused on privacy controls, data subject rights, and privacy impact assessments. Same write/approve scope as COMPLIANCE_OFFICER but signals a privacy specialization. Displayed as **Approver (Privacy)**.
  </Accordion>
  <Accordion title="SECURITY_OFFICER">
    Approver role focused on technical and security controls, incident response, and security assessments. Same write/approve scope as COMPLIANCE_OFFICER but signals a security specialization. Displayed as **Approver (Security)**.
  </Accordion>
  <Accordion title="EMPLOYEE">
    Limited access. Can view assigned policies, sign acknowledgment campaigns, and submit basic information. Displayed as **Analyst**.
  </Accordion>
...
<Note>
  A tenth role, **SUPER_ADMIN**, exists for platform operators only — it is not assignable from the Team Members invite flow and is not part of the roles you'll pick from as a customer.
</Note>
