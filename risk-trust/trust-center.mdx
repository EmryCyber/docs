...
<Steps>
  ...
  <Step title="Choose what to show">
    Toggle each section: Compliance Score, Frameworks, Policies, Control Stats, Certifications, Security Practices, and Subprocessors. FAQs display automatically once you've added any (see below) — there's no separate toggle for them.
  </Step>
