...
<Tabs>
  ...
  <Tab title="SOC 2">
    - **Trust Service Criteria** — controls organized by Security, Availability, Processing Integrity, Confidentiality, and Privacy
    - **Control activity mapping** — link controls to specific TSC points for auditor readability
    - **Type I vs. Type II tracking** — differentiate between point-in-time and period-of-time assessments
  </Tab>
  <Tab title="CMMC">
