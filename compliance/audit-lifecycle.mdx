...
<Steps>
  <Step title="Open Audit Periods">
    In the Compliance module sidebar, open the **Evidence & Reporting** group and click **Audit Periods**. (The Evidence & Reporting group only appears after you have adopted at least one framework — see [Frameworks](/compliance/frameworks) for the adoption step.)
  </Step>
...
<Steps>
  <Step title="Open Compliance Issues">
    In the Compliance module sidebar, open the **Evidence & Reporting** group and click **Issues**.
  </Step>
