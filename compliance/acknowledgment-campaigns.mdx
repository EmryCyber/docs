...
<Steps>
  <Step title="Open Policy Campaigns">
    In the Compliance module sidebar, open the **Compliance** group and click **Campaigns**.
  </Step>
...
<Steps>
  <Step title="Open the campaign">
    In the Compliance module sidebar, open the **Compliance** group, click **Campaigns**, and select the campaign name.
  </Step>
