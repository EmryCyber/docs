...
<Steps>
  <Step title="Navigate to Control Tests">
    In the Compliance module sidebar, open the **Evidence & Reporting** group and click **Control Tests** to view all defined tests. (The Evidence & Reporting group only appears after you have adopted at least one framework — see [Frameworks](/compliance/frameworks).)
  </Step>
